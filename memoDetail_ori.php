    ...
    <section id="main">
      <div class="form-container">
        ...
        <!-- リスト名 -->
           ...
           <label class="category_id <?php if (!empty($err_msg['category_id'])) {
                echo 'err';
            } ?>">
            リスト
           </label>
...
debug('getFormData(category_id)の中身：'.print_r($test, true));
        ...
        <!-- タイトル -->
          <label class="memo-title  <?php if (!empty($err_msg['memotitle'])) {
                echo "err";
            } ?>">タイトル </label>
        ...
        <!-- メモ内容 -->
          <label class="memo-contents <?php if (!empty($err_msg['contents'])) {
                echo "err";
            } ?>">メモ</label>
